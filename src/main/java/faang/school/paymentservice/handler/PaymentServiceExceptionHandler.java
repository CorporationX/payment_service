...
import faang.school.paymentservice.dto.error.PaymentServiceErrorResponseDto;
...
public class PaymentServiceExceptionHandler {
    ...
    static {
        ...
        HTTP_STATUS_MAP.put(PaymentOperationNotFoundException.class, HttpStatus.NOT_FOUND);
        ...
        HTTP_STATUS_MAP.put(RedisUnavailableException.class, HttpStatus.SERVICE_UNAVAILABLE);
    }
    ...
    public ResponseEntity<PaymentServiceErrorResponseDto> handleException(Exception ex) {
    ...
    public ResponseEntity<PaymentServiceErrorResponseDto> handleGenericException(Exception ex) {
    ...
    private ResponseEntity<PaymentServiceErrorResponseDto> createErrorResponse(String errorMsg,
                                                                            HttpStatus status,
                                                                            Exception ex) {
        log.error("Error in payment-service: {}, response status {}", errorMsg, status, ex);
        PaymentServiceErrorResponseDto response =
                new PaymentServiceErrorResponseDto(errorMsg, LocalDateTime.now(), status.value());
