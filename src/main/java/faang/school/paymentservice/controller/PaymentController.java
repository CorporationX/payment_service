...
public class PaymentController {
    ...
    public ResponseEntity<PaymentResponse> sendPayment(@RequestBody @Validated PaymentRequest dto) {
        try {
            BigDecimal convertedAmount = currencyConverterService.convert(dto.currency(), targetCurrency, dto.amount());
    ...
    public BigDecimal convert(@PathVariable("amount") BigDecimal amount,
    ...
    public Map<String, Double> getRates() {
        return currencyRatesService.fetch();
    }
}