...
public class KafkaProducerConfig {
    ...
    @Bean
    public KafkaTemplate<String, TransferEventRequest> transferEventKafkaTemplate() {
        return new KafkaTemplate<>(jsonProducerFactory());
    }

    @Bean
    public KafkaTemplate<String, CancelTransferEventRequest> cancelTransferEventKafkaTemplate() {
        return new KafkaTemplate<>(jsonProducerFactory());
    }
