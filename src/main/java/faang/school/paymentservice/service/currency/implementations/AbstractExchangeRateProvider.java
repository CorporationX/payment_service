...
@Slf4j
public abstract class AbstractExchangeRateProvider<T> implements ExchangeRateProvider {
    ...
    protected abstract T fetchResponse();
    protected abstract Integer getTimestamp(T response);
    protected abstract String getBase(T response);
    protected abstract Map<String, BigDecimal> getRates(T response);
