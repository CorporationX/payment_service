...
public class GlobalExceptionHandler {
    private static final Map<Class<? extends Exception>, HttpStatus> EXCEPTION_STATUS_MAP = Map.ofEntries(
            ...
            Map.entry(DuplicatePaymentException.class, HttpStatus.BAD_REQUEST),
            Map.entry(PaymentOperationException.class, HttpStatus.BAD_REQUEST),
            Map.entry(PaymentNotFoundException.class, HttpStatus.NOT_FOUND)
    );
