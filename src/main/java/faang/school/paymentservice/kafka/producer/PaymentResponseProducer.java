...
@Component
@Slf4j
public class PaymentResponseProducer extends AbstractProducer {

    @Value("${kafka-topic.producer.payment-response}")
    private String topic;
    private final JsonUtil jsonUtil;

    public PaymentResponseProducer(KafkaTemplate<String, String> kafkaTemplate,
                                   JsonUtil jsonUtil) {
        super(kafkaTemplate);
